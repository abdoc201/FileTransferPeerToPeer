...
public class MainForm extends javax.swing.JFrame {
    ...
    public void connect() {
        appendMessage(" Connecting...", "Status", Color.BLUE, Color.BLUE);
        try {
            ...
            isConnected = false;
            JOptionPane.showMessageDialog(this, "Could not connect to the server, please try again later.!", "Connection failed", JOptionPane.ERROR_MESSAGE);
    ...
    */
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(16,43,91));
        ...
        if (!attachmentOpen) {
            ...
            if (s.prepare(username, host, port, this)) {
                ...
                JOptionPane.showMessageDialog(this,
                        "Unable to set up File Sharing at this time, please try again later!", "Error",
