...
public class SocketThread implements Runnable {
    ...
    private void createConnection(String receiver, String sender, String filename) {
        try {
            main.appendMessage("[createConnection]: Peers have established connection.");
            ...
            if (s != null) { 
                ...
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver + "' Not found");
            }
        } catch (IOException e) {
    ...
    public void run() {
        try {
            while (true) {
                ...
                switch (CMD) {
                    case "CMD_JOIN":
                        ...
                        main.appendMessage("[Client]: " + clientUsername + "online");
                        break;
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                            ...
                            main.appendMessage("[IOException]: Unable to send a message to " + sendTo);
                        }
                        break;
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : Client is setting up a socket for a file-sharing connection");
                        ...
                        main.appendMessage("CMD_SHARINGSOCKET : File Sharing is currently open");
                        break;
                    ...
                    case "CMD_SENDFILE":
                        ...
                        if (cSock != null) {
                            ...
                            try {
                                main.appendMessage("CMD_SENDFILE : Connection established!");
                            ...
                            main.removeClientFileSharing(consignee);
                            main.appendMessage("CMD_SENDFILE : Peer '" + sendto + "' not found.!");
                            DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                            dos.writeUTF("CMD_SENDFILEERROR " + "Peer '" + sendto + "' not found, File Sharing will exit.");
                        }
                        break;
            ...
            main.appendMessage("[SocketThread]: Peer connection closed!");
        }
